(function ($) {
  ...
  function filterCatalog() {
    $(".filter-btn").on("click", function () {
      ...
      $("#catalog .catalog-card").each(function () {
  ...
  function filterOfferCatalog() {
    $(".offer-filter-btn").on("click", function () {
      var filter = $(this).data("offer-filter");

      $(".offer-filter-btn").removeClass("active");
      $(this).addClass("active");

      $("#offer-catalog .offer-card").each(function () {
        var tags = String($(this).data("offer-tags"));
        var show = filter === "all" || tags.indexOf(filter) !== -1;
